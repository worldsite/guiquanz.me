...
> <span class="badge badge-warning">(0)</span>. 清除本地化本地化LC_\*配置，确保脚本正常运行：
...
目前[淘宝团队](http://tengine.taobao.org)开发的Nginx衍生品[Tengine](https://github.com/taobao/tengine)就是用这两个库测试的。可参考[Tengine的测试](https://github.com/taobao/tengine/wiki/tests_with_tengine)说明。
